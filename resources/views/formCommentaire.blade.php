...
<div class="col-md-12 well well-sm">
    ...
    <div class="form-horizontal">    
        ...
        <div class="form-group">
            ...
            <div class="col-md-3">
                <input type="text" name="genre" 
                       value="{{ $manga->dessinateur->prenom_dessinateur }} {{ $manga->dessinateur->nom_dessinateur }}" class="form-control"  readonly >
            </div>
        </div>     
        <div class="form-group">
        ...
        <div class="form-group">
            ...
            <div class="col-md-5">
                {{Form::textarea("lib_commentaire",old("lib_commentaire") ? old("lib_commentaire"): (!empty($commentaire) ? $commentaire->lib_commentaire : null),
                ["class"=>"form-control", "placeholder"=>"votre commentaire", "required", "autofocus", $readonly])
                }}
            </div>
