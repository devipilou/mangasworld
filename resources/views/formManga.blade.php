...
<div class="col-md-12 well well-sm">
    ...
    <div class="form-horizontal">    
        ...
        <div class="form-group">
            ...
            <div class="col-md-3">
                {{Form::select('cbGenre',$genres->pluck('lib_genre', 'id_genre'), $manga->idgenre, 
                    ['class'=>'form-control', 'placeholder'=>'Selectionner un genre', $readonly])
                }}
            </div>
            @error('cbGenre')
                <span class="invalid-feedback" role="alert">
        ...
        <div class="form-group">
            ...
            <div class="col-md-3">
                {{Form::select('cbScenariste',$scenaristes->pluck('nom_scenariste', 'id_scenariste'), $manga->idScenariste, 
                    ['class'=>'form-control', 'placeholder'=>'Selectionner un Scenariste', $readonly])
                }}
            </div>
            @error('cbScenariste')
                <span class="invalid-feedback" role="alert">
        ...
        <div class="form-group">
            ...
            <div class="col-md-3">
                {{Form::select('cbDessinateur',$dessinateurs->pluck('nom_dessinateur', 'id_dessinateur'), $manga->idDessinateur, 
                    ['class'=>'form-control', 'placeholder'=>'Selectionner un Dessinateur', $readonly])
                }}
            </div>
            @error('cbDessinateur')
                <span class="invalid-feedback" role="alert">
        ...
        <div class="form-group">
            ...
            <div class="col-md-3">
                {{Form::text("prix",old("prix") ? old("prix") : (!empty($manga) ? $manga->prix : null), 
                            ["class"=>"form-control", "placeholder"=>"Prix", "required", "autofocus", $readonly])
                }}
            </div>
            @error('prix')
                <span class="invalid-feedback" role="alert">
