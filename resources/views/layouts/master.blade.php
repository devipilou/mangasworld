...
<html lang="fr">
    <head>
        ...
        <link href="{{ secure_asset('assets/css/mangas.css') }}" rel="stylesheet">
        <link href="{{ secure_asset('assets/css/bootstrap-theme.css') }}" rel="stylesheet">
        <!-- Scripts -->
    ...
    <body class="body">
        ...
        <script src="{{ secure_asset('assets/js/jquery-2.1.3.min.js') }}" defer></script>
        <script src="{{ secure_asset('assets/js/bootstrap.js') }}" defer></script>      
    </body>
</html>
