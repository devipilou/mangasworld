...
<div class="container">
    ...
    <table class="table table-bordered table-striped">
        ...
        <tr>   
            ...
            <td> {{ $manga->dessinateur->prenom_dessinateur }} {{ $manga->dessinateur->nom_dessinateur }}</td>
            <td> {{ $manga->scenariste->prenom_scenariste }} {{ $manga->scenariste->nom_scenariste }} </td>
            <td> {{ $manga->prix }} </td>
            
            <td style="text-align:center"><a href="{{ url('/listerCommentaires')}}/{{ $manga->id_manga}}">
                <span class="glyphicon glyphicon-eye-open" data-toggle="tooltip" data-placement="top" title="Commentaires"></span></a>
            </td>
